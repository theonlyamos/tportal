...
<html lang="en">
	...
	<head>
		<meta charset="utf-8" />
		<title>Contact us | Tournament Portal</title>
                        ...
                        <div class="m-portlet__body">
                          <div class="form-group m-form__group row">
                            <div class="col-10 ml-auto">
                              <h3 class="m-form__section">Get in touch with us</h3>
                            </div>
                          </div>
                          <div class="form-group m-form__group row">
                          ...
                          <div class="form-group m-form__group row">
                            ...
                            <div class="col-7">
                              <textarea class="form-control m-input" rows="3" name="email" required></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="m-portlet__foot m-portlet__foot--fit">
                          <div class="m-form__actions">
                            <div class="row">
                              ...
                              <div class="col-7">
                                  <button type="reset" class="btn btn-accent m-btn m-btn--air m-btn--custom">Send</button>&nbsp;&nbsp;
                                </div>
                            </div>
                          </div>
                        </div>
