                      ...
                      <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                          <div class="col-10 ml-auto">
                            <h3 class="m-form__section">Tell us what you think</h3>
                          </div>
                        </div>
                        <div class="form-group m-form__group row">
                          <div class="col-10 ml-auto">
                              <h5 class="ls-1 fw-1">
                                  We have tried our best to make TournamentPortal really easy to use. If you still find any 
                                  <br>issue in using it, feel free to contact us. If you have any thing that you might want to know about,
                                  <br>do write to us as well.
                              </h5>
                          </div>
                        </div>
                        <div class="form-group m-form__group row">
                        ...
                        <div class="form-group m-form__group row">
                          <label for="example-text-input" class="col-2 col-form-label">Your Feedback</label>
                          <div class="col-7">
                      ...
                      <div class="m-portlet__foot m-portlet__foot--fit">
                        <div class="m-form__actions">
                          <div class="row">
                            ...
                            <div class="col-7">
                                <button type="reset" class="btn btn-accent m-btn m-btn--air m-btn--custom">Submit</button>&nbsp;&nbsp;
                            </div>
                          </div>
                        </div>
                      </div>
