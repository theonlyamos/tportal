										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="m_widget11_tab1_content">
												...
												<div class="m-widget11">
													<form class="m-form m-form--fit m-form--label-align-right auth coach" action="coach_register.php" method="post">
...
?>
															...
															<div class="form-group m-form__group">
																<input class="form-control m-input" type="text" placeholder="Trainer Title" name="trainertitle" required>
															</div>
															<div class="form-row m-form__group">
																<div class="col-6">
