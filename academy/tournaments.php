									...
									<div class="m-portlet__body">
										...
										<div class="form-group m-form__group row">
											<div class="col-lg-12 m-form__group-sub">
												...
												<?php
													echo '<input type="text" name="author" class="form-control m-input bg-secondary" placeholder="" value="'.$_SESSION['user']['name'].'" readonly>';
												?>
...
_END;
if ($tournament['approved']) echo '<td><div class="m-badge m-badge--wide m-badge--primary approved-'.$tournament['id'].'">approved</div></td>';
else if ($tournament['rejected']) echo '<td><div class="m-badge m-badge--wide m-badge--danger approved-'.$tournament['id'].'">rejected</div></td>';
else echo '<td><div class="m-badge m-badge--wide approved-'.$tournament['id'].'">pending</div></td>';
echo <<< _END
