...
$result = queryDB("SELECT users.id as id, fullname, profession, country, email, verified, phone,approved FROM users left join players_map on users.id = players_map.user_id WHERE country = '$country' and players_map.academy_id is null and profession = 'player' ORDER BY createdAt DESC");
...
for ($j = 0; $j < $result->num_rows; ++$j){
	...
	echo <<< _END
									<tr><td>$user[fullname]</td><td>$user[profession]</td><td>$user[country]</td><td>$user[email]</td><td>$user[phone]</td><td><a href = "mapPlayer.php?id=$userid"><div class="m-badge m-badge--wide m-badge--primary">Add</div></a></td>
_END;
