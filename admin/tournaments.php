										...
										<div id="arbiters">
											<div class="form-group m-form__group row">
												<div class="col-11 m-form__group-sub">
													...
													<input type="phone" id="add_arbiter_input" class="form-control m-input" placeholder="Enter name of an arbiter" value="">
												</div>
										...
										<div id="coaches">
											<div class="form-group m-form__group row">
												<div class="col-11 m-form__group-sub">
													...
													<input type="phone" id="add_coache_input" class="form-control m-input" placeholder="Enter name of a coach" value="">
												</div>
												<div class="col-1 m-form__group-sub">
													<label class="form-control-label text-center">&#8203;</label>
