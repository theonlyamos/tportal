															...
															<div class="m-dropdown__body">
																<div class="m-dropdown__content">
																	<ul class="m-nav">
																		...
																		<li class="m-nav__item" id="close_ticket" data-target="$ticket[ticketnum]" data-user="$ticket[userid]">
																			<a href="#" class="m-nav__link">
																				<i class="m-nav__link-icon flaticon-cancel"></i>
																				<span class="m-nav__link-text">Close</span>
																			</a>
																		</li>
																		<li class="m-nav__item"  id="delete_ticket" data-target="$ticket[ticketnum]" data-user="$ticket[userid]">
																			<a href="#" class="m-nav__link">
